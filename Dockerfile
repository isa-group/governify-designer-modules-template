...
# Install nodejs as "alpine-node" docker image
...
# Copy FaMa
COPY ./bin/fama-shell.jar /bin/

# Start FaMa service
RUN mkdir governify-designer-module-fama
WORKDIR /tmp/governify-designer-module-fama
ADD . ./
RUN npm install
EXPOSE 80 443
CMD node index.js